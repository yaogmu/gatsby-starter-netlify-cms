...
Since this starter using the [netlify-dev](https://www.netlify.com/verein/dev/#how-it-works), there could be further issues you, please check the [netlify-dev](https://github.com/netlify/netlify-dev) repository for further information and set up questions. 
